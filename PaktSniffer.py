...
#make sure you install the Python3 version of scapy - pip3 install scapy. You machine may 
#default to python2.x
try:
...
#TODO - since this is probably going to run on a VM, I should put choices in there - automatically detect the interfaces
